...
int main(){
    ...
    */
    ...
    string s = "MMC_no_swap/0.5_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_1, L, L, s);
    s = "MMC_no_swap/0.8_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_2, L, L, s);
    s = "MMC_no_swap/T_c_lattice.txt";
    saveMatrixToFile_int(lattice_3, L, L, s);
    s = "MMC_no_swap/1.5_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_4, L, L, s);
    s = "MMC_no_swap/2_T_c_lattice.txt";
    ...
    // Store final results
    s = "MMC_no_swap/" + to_string(tot_steps) + "_0.5_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_1, L, L, s);
    s = "MMC_no_swap/" + to_string(tot_steps) + "_0.8_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_2, L, L, s);
    s = "MMC_no_swap/" + to_string(tot_steps) + "_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_3, L, L, s);
    s = "MMC_no_swap/" + to_string(tot_steps) + "_1.5_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_4, L, L, s);
    s = "MMC_no_swap/" + to_string(tot_steps) + "_2_T_c_lattice.txt";
    saveMatrixToFile_int(lattice_5, L, L, s);
    

    s = "MMC_no_swap/0.5_T_c_magnetization.txt";
    saveResultsToFile(Magnetization_1, tot_steps, s);
    s = "MMC_no_swap/0.8_T_c_magnetization.txt";
    saveResultsToFile(Magnetization_2, tot_steps, s);
    s = "MMC_no_swap/T_c_magnetization.txt";
    saveResultsToFile(Magnetization_3, tot_steps, s);
    s = "MMC_no_swap/1.5_T_c_magnetization.txt";
    saveResultsToFile(Magnetization_4, tot_steps, s);
    s = "MMC_no_swap/2_T_c_magnetization.txt";
    saveResultsToFile(Magnetization_5, tot_steps, s);

    s = "MMC_no_swap/0.5_T_c_energy.txt";
    saveResultsToFile(Energy_observale_1, tot_steps, s);
    s = "MMC_no_swap/0.8_T_c_energy.txt";
    saveResultsToFile(Energy_observale_2, tot_steps, s);
    s = "MMC_no_swap/T_c_energy.txt";
    saveResultsToFile(Energy_observale_3, tot_steps, s);
    s = "MMC_no_swap/1.5_T_c_energy.txt";
    saveResultsToFile(Energy_observale_4, tot_steps, s);
    s = "MMC_no_swap/2_T_c_energy.txt";
