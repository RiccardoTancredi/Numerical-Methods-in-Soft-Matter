...
int main(){
    ...
    */
    ...
    char s[100] = "res/0_lattice_2D_Ising.txt";
    char s1[100] = "res/1000_lattice_2D_Ising.txt";
    char s2[100] = "res/10000_lattice_2D_Ising.txt";
    char s3[100] = "res/100000_lattice_2D_Ising.txt";
    char s4[100] = "res/1000000_lattice_2D_Ising.txt";
    ...
    for (int t = 0; t < tot_steps; t++){
        ...
        if (t == 0){
            ...
            saveMatrixToFile_int(lattice, L, L, s1);
        }
        else if (t == 10000){
            saveMatrixToFile_int(lattice, L, L, s2);    
        }
        else if (t == 100000){
            saveMatrixToFile_int(lattice, L, L, s3);
        }
        else if (t == 1000000-1){
            saveMatrixToFile_int(lattice, L, L, s4);
        }
    }
