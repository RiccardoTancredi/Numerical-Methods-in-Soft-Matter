void read_input_file()
{
    ...
    while(fgets(line, sizeof(line), _myfile) != NULL){
      ...
      if(strcmp("gamma",_key) == 0){ mySys.gamma = atof(_value); continue; }
      if(strcmp("K",_key) == 0){ mySys.K = atof(_value); continue; }
      if(strcmp("exercise",_key) == 0){ mySys.exercise = atof(_value); continue; }
      ...
      if(strcmp("mass",_key) == 0){ mySys.m = atof(_value); continue; }
      if(strcmp("sigma_cut",_key) == 0){ mySys.sigma_cut = atof(_value); continue; }
      if(strcmp("spring_2_x",_key) == 0){ mySys.spring_2_x = atof(_value); continue; }
      if(strcmp("spring_2_y",_key) == 0){ mySys.spring_2_y = atof(_value); continue; }
      ...
      if(strcmp("eps",_key) == 0){ mySys.eps = atoi(_value); continue; }    
      if(strcmp("model",_key) == 0){ mySys.model = atoi(_value); continue; }    
      if(strcmp("integrator",_key) == 0){ mySys.integrator = atoi(_value); continue; }    
